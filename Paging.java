 ...
 * The checkAddr() is the method called by the kernel readAddr and writeAddr
...
public class Paging {
	...
	/*----------------------------------------------------------------------------------
	 * checkAddr simulates page faults - that is will generate a page fault (log message)
	 ...
	 * --------------------------------------------------------------------------------*/
	public int checkAddr(long memAddr) // checks if page is loaded into physical
	// mem
	{
